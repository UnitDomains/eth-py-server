...
public_resolver_event_interface_changed_table_columns = [
...
def insert_public_resolver_event_interface_changed(block_number,
    ...
    :return:
    """
    delete_public_resolver_event_interface_changed(network_id,
                                                   block_number,
                                                   tx_hash,
                                                   log_index)
    ...
    try:
        ...
        print("insert_public_resolver_event_interface_changed")
        print(e)
        conn.rollback()


def delete_public_resolver_event_interface_changed(network_id,
                                                   block_number,
                                                   tx_hash,
                                                   log_index):
    sql = """
        DELETE FROM public_resolver_event_interface_changed 
    ...
    try:
        ...
        print("delete_public_resolver_event_interface_changed")
        print(e)
        conn.rollback()


def delete_public_resolver_event_interface_changed_after_block(network_id,
                                                               block_number):
    '''
    ...
    try:
        ...
        print("delete_public_resolver_event_interface_changed_after_block")
        print(e)
        conn.rollback()

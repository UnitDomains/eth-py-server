...
from database.info.PriceInfo import update_price_info_register_price
...
def insert_price_oracle_event_register_price_changed(block_number,
                                                     ...
                                                     prices,
                                                     timestamp):
    delete_price_oracle_event_register_price_changed(network_id,
                                                     block_number,
                                                     tx_hash,
                                                     log_index
                                                     )
    ...
    try:
        ...
        print("insert_price_oracle_event_register_price_changed")
        print(e)
        conn.rollback()


def delete_price_oracle_event_register_price_changed(network_id,
                                                     block_number,
                                                     tx_hash,
                                                     log_index
                                                     ):
    sql = """
        DELETE FROM price_oracle_event_register_price_changed 
    ...
    try:
        ...
        print("delete_price_oracle_event_register_price_changed")
        print(e)
        conn.rollback()


def delete_price_oracle_event_register_price_changed_after_block(network_id,
                                                                 block_number):
    '''
    ...
    try:
        ...
        print("delete_price_oracle_event_register_price_changed_after_block")
        print(e)
        conn.rollback()

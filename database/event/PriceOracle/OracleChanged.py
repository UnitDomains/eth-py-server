...
def insert_price_oracle_event_oracle_changed(block_number,
    ...
    delete_price_oracle_event_oracle_changed(network_id,
                                             block_number,
                                             tx_hash,
                                             log_index)
    ...
    try:
        ...
        print("insert_price_oracle_event_oracle_changed")
        print(e)
        conn.rollback()


def delete_price_oracle_event_oracle_changed(network_id,
                                             block_number,
                                             tx_hash,
                                             log_index):
    sql = """
        DELETE FROM price_oracle_event_oracle_changed 
    ...
    try:
        ...
        print("delete_price_oracle_event_oracle_changed")
        print(e)
        conn.rollback()


def delete_price_oracle_event_oracle_changed_after_block(network_id,
                                                         block_number):
    '''
    ...
    try:
        ...
        print("delete_price_oracle_event_oracle_changed_after_block")
        print(e)
        conn.rollback()

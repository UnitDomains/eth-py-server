...
from database.event.ReverseRegistrar.model.ControllerChangedEventData import ControllerChangedEventData
from database.utils import get_uuid

reverse_registrar_event_controller_changed_table_columns = [
...
def insert_reverse_registrar_event_controller_changed(block_number,
    ...
    :return:
    """
    delete_reverse_registrar_event_controller_changed(network_id,
                                                      block_number,
                                                      tx_hash,
                                                      log_index)
    sql = """
    ...
    try:
        ...
        print("insert_reverse_registrar_event_controller_changed")
        print(e)
        conn.rollback()


def delete_reverse_registrar_event_controller_changed(network_id,
                                                      block_number,
                                                      tx_hash,
                                                      log_index):
    sql = """
        DELETE FROM reverse_registrar_event_controller_changed 
    ...
    try:
        ...
        print("delete_reverse_registrar_event_controller_changed")
        print(e)
        conn.rollback()


def delete_reverse_registrar_event_controller_changed_after_block(network_id,
                                                                  block_number):
    '''
    ...
    try:
        ...
        print("delete_reverse_registrar_event_controller_changed_after_block")
        print(e)
        conn.rollback()


def get_reverse_registrar_event_controller_changed(network_id,
                                                   node
                                                   ):
    """
    """
    ...
    try:
        ...
        if cur.rowcount > 0:
            ...
            return ControllerChangedEventData(pk_id,
                                              node,
                                              addr,
                                              network_id,
                                              block_number,
...
def get_all_reverse_registrar_event_controller_changed(network_id,
                                                       node
                                                       ):
    """
    """
    ...
    try:
        ...
        if cur.rowcount > 0:
            ...
            for row in rows:
                ...
                res = ControllerChangedEventData(pk_id,
                                                 node,
                                                 addr,
                                                 network_id,
                                                 block_number,

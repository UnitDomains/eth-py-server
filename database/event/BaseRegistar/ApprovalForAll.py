...
from database.event.BaseRegistar.model.ApprovalForAllEventData import ApprovalForAllEventData
from database.utils import get_uuid

base_registrar_event_approval_for_all_table_columns = [
...
def insert_base_registrar_event_approval_for_all(block_number,
                                                 ...
                                                 approved,
                                                 timestamp):
    delete_base_registrar_event_approval_for_all(network_id,
                                                 block_number,
                                                 tx_hash,
                                                 log_index)
    ...
    try:
        ...
        print("insert_base_registrar_event_approval_for_all")
        print(e)
        conn.rollback()


def delete_base_registrar_event_approval_for_all(network_id,
                                                 block_number,
                                                 tx_hash,
                                                 log_index):
    sql = """
        DELETE FROM base_registrar_event_approval_for_all 
    ...
    try:
        ...
        print("delete_base_registrar_event_approval_for_all")
        print(e)
        conn.rollback()


def delete_base_registrar_event_approval_for_all_after_block(network_id,
                                                             block_number):
    '''
    ...
    try:
        ...
        print("delete_base_registrar_event_approval_for_all_after_block")
        print(e)
        conn.rollback()
...
def get_base_registrar_event_approval_for_all(network_id,
                                              node
                                              ):
    """
    """
    ...
    sql = """
            ...
            FROM base_registrar_event_approval_for_all 
    ...
    try:
        ...
        print("get_base_registrar_event_approval_for_all")

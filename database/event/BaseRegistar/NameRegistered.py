...
from database.event.BaseRegistar.model.NameRegisteredEventData import NameRegisteredEventData
from database.utils import get_uuid

base_registrar_event_name_registered_table_columns = [
...
def insert_base_registrar_event_name_registered(block_number,
    ...
    delete_base_registrar_event_name_registered(network_id,
                                                block_number,
                                                tx_hash,
                                                log_index)
    ...
    try:
        ...
        print("insert_base_registrar_event_name_registered")
        print(e)
        conn.rollback()


def delete_base_registrar_event_name_registered(network_id,
                                                block_number,
                                                tx_hash,
                                                log_index):
    sql = """
        DELETE FROM base_registrar_event_name_registered 
    ...
    try:
        ...
        print("delete_base_registrar_event_name_registered")
        print(e)
        conn.rollback()


def delete_base_registrar_event_name_registered_after_block(network_id,
                                                            block_number):
    '''
    ...
    try:
        ...
        print("delete_base_registrar_event_name_registered_after_block")
        print(e)
        conn.rollback()


def convertRow2NameRegisteredEventData(row):
    '''
    ...
    return NameRegisteredEventData(pk_id,
                                   id,
                                   owner,
                                   expires,
                                   network_id,
...
def get_base_registrar_event_name_registered(network_id,
                                             node
                                             ):
    """
    """
    ...
    try:
        ...
        if cur.rowcount > 0:
            ...
            return convertRow2NameRegisteredEventData(row)
        ...
        print("get_base_registrar_event_name_registered")
